# Generated by Django 5.0.3 on 2025-02-25 16:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Designates whether the user is an administrator for their firm', verbose_name='Firm Administrator')),
                ('full_name', models.CharField(blank=True, max_length=255)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User')], default='user', max_length=50)),
                ('firm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='users_app.firm')),
